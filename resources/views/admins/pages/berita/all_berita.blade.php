                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="d-flex align-items-center">
                                <a href="{{ route('admin.berita.edit', $row->slug) }}" class="edit"><i
                                        class="bi bi-pencil-square" data-toggle="tooltip" title="Edit"></i></a>

                                <a href="{{ route('admin.berita.preview', $row->slug) }}" class="preview"><i
                                        class="bi bi-card-text" data-toggle="tooltip" title="Preview"></i></a>

                                <form class="delete" method="POST" action="{{ route('admin.berita.delete', $row->slug) }}"
