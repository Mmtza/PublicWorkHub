                            ...
                            <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="{{ route('admin.berita') }}" data-bs-toggle=""
                                        aria-expanded="false">
                                        <div class="d-flex align-items-center"><span class="nav-link-text">Berita</span>
                                        </div>
                                    </a><!-- more inner pages-->
                                    <a class="nav-link active" href="{{ route('admin.loker') }}" data-bs-toggle=""
                                        aria-expanded="false">
                                        <div class="d-flex align-items-center"><span class="nav-link-text">Loker</span>
                                        </div>
                                    </a><!-- more inner pages-->
...
<nav class="navbar navbar-top fixed-top navbar-expand" id="navbarDefault">
    <div class="collapse navbar-collapse justify-content-between">
        ...
        <ul class="navbar-nav navbar-nav-icons flex-row">
            ...
            <li class="nav-item">
                <a class="nav-link px-3" href="{{ route('loker/chat') }}"><span class="ms-1"><i
                            class="fa-regular fa-message fa-lg"></i></span></a>
            </li>
            {{-- notification --}}
            ...
            <li class="nav-item dropdown">
                <a class="nav-link lh-1 pe-0" id="navbarDropdownUser" href="#!" role="button"
                    ...
                    <div class="avatar avatar-l">
                        ...
                        @else
                            <img class="rounded-circle"
                                src="{{ asset('assets/users/images/' . Auth::user()->foto) }}" alt="" />
                        @endif
                    </div>
                </a>
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="overflow-auto scrollbar">
                                <ul class="nav d-flex flex-column pb-1">
                                    <li class="nav-item">
                                        <a class="nav-link px-3" href="{{ route('profile.edit') }}"><span
                                                class="ms-1 me-2 text-900"><i
                                                    class="fa-regular fa-user"></i></span><span>Profile</span></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link px-3" href="{{ route('loker/chat') }}"><span
                                                class="ms-1 me-2 text-900"><i
                                                    class="fa-regular fa-message"></i></span><span>Chat</span></a>
                                    </li>
                                </ul>
                            </div>
                            <hr />
                                ...
                                <form class="bg-transparent" action="{{ route('logout') }}" method="POST">
                                    ...
                                    <button type="submit"
                                        class="btn btn-phoenix-secondary d-flex flex-center w-100"><span
                                            class="me-2" data-feather="log-out"></span> Logout</button>
                                </form>
                            </div>
                        </div>
                    </div>
