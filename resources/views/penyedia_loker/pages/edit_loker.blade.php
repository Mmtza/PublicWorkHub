...
<form class="d-flex mb-3" method="POST" action="{{ route('penyedia-loker.loker.delete', $loker->slug) }}" id="deleteLokerForm">
    @csrf
    @method('delete')
...
@endif
<form class="form-control row g-2 py-3" method="POST" enctype="multipart/form-data" action={{ route('penyedia-loker.loker.edit.patch', $loker->slug) }}>
    @csrf
    @method('patch')
