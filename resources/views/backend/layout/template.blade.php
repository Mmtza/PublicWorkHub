...
<head>
    ...
    <title>Sistem Kasir Toko Batik</title>
    ...
    <link rel="apple-touch-icon" sizes="180x180"
        href="{{ asset('backend/themes') }}/assets/img/favicons/apple-touch-icon.png" />
    <link rel="icon" type="image/png" sizes="32x32"
        href="{{ asset('backend/themes') }}/assets/img/favicons/favicon-32x32.png" />
    <link rel="icon" type="image/png" sizes="16x16"
        href="{{ asset('backend/themes') }}/assets/img/favicons/favicon-16x16.png" />
    <link rel="shortcut icon" type="image/x-icon"
        href="{{ asset('backend/themes') }}/assets/img/favicons/favicon.ico" />
    <link rel="manifest" href="{{ asset('backend/themes') }}/assets/img/favicons/manifest.json" />
    <meta name="msapplication-TileImage" content="assets/img/favicons/mstile-150x150.png" />
    <meta name="theme-color" content="#ffffff" />
    <script src="{{ asset('backend/themes') }}/vendors/imagesloaded/imagesloaded.pkgd.min.js"></script>
    <script src="{{ asset('backend/themes') }}/vendors/simplebar/simplebar.min.js"></script>
    <script src="{{ asset('backend/themes') }}/assets/js/config.js"></script>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Nunito+Sans:wght@300;400;600;700;800;900&amp;display=swap"
        rel="stylesheet" />
    <link href="{{ asset('backend/themes') }}/vendors/simplebar/simplebar.min.css" rel="stylesheet" />
    <link rel="stylesheet"
        href="{{ asset('backend/themes') }}/../../../unicons.iconscout.com/release/v4.0.8/css/line.css" />
    <link href="{{ asset('backend/themes') }}/assets/css/theme-rtl.min.css" type="text/css" rel="stylesheet"
        id="style-rtl" />
    <link href="{{ asset('backend/themes') }}/assets/css/theme.min.css" type="text/css" rel="stylesheet"
        id="style-default" />
    <link href="{{ asset('backend/themes') }}/assets/css/user-rtl.min.css" type="text/css" rel="stylesheet"
        id="user-style-rtl" />
    <link href="{{ asset('backend/themes') }}/assets/css/user.min.css" type="text/css" rel="stylesheet"
    ...
    <link href="{{ asset('backend/themes') }}/vendors/leaflet/leaflet.css" rel="stylesheet" />
    <link href="{{ asset('backend/themes') }}/vendors/leaflet.markercluster/MarkerCluster.css" rel="stylesheet" />
    <link href="{{ asset('backend/themes') }}/vendors/leaflet.markercluster/MarkerCluster.Default.css"
        rel="stylesheet" />
</head>
...
<body>
                ...
                <div class="row gx-2">
                    <div class="col-6">
                        <input class="btn-check" id="themeSwitcherLight" name="theme-color" type="radio"
                            ...
                            <span class="mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                    src="{{ asset('backend/themes') }}/assets/img/generic/default-light.png"
                    ...
                    <div class="col-6">
                        <input class="btn-check" id="themeSwitcherDark" name="theme-color" type="radio"
                            ...
                            <span class="mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                    src="{{ asset('backend/themes') }}/assets/img/generic/default-dark.png"
                ...
                <div class="row gx-2">
                    ...
                    <div class="col-6">
                        <input class="btn-check" id="navbarPositionHorizontal" name="navigation-type" type="radio"
                            ...
                            <span class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none"
                                    src="{{ asset('backend/themes') }}/assets/img/generic/top-default.png"
                                    alt="" /><img class="img-fluid img-prototype d-light-none"
                                    src="{{ asset('backend/themes') }}/assets/img/generic/top-default-dark.png"
                                    alt="" /></span><span class="label-text">
                    ...
                    <div class="col-6">
                        <input class="btn-check" id="navbarPositionCombo" name="navigation-type" type="radio"
                            ...
                            <span class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none"
                                    src="{{ asset('backend/themes') }}/assets/img/generic/nav-combo-light.png"
                                    alt="" /><img class="img-fluid img-prototype d-light-none"
                                    src="{{ asset('backend/themes') }}/assets/img/generic/nav-combo-dark.png"
                    ...
                    <div class="col-6">
                        <input class="btn-check" id="navbarPositionTopDouble" name="navigation-type" type="radio"
                            ...
                            <span class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none"
                                    src="{{ asset('backend/themes') }}/assets/img/generic/dual-light.png"
                                    alt="" /><img class="img-fluid img-prototype d-light-none"
                                    src="{{ asset('backend/themes') }}/assets/img/generic/dual-dark.png"
                ...
                <div class="row gx-2">
                    ...
                    <div class="col-6">
                        <input class="btn-check" id="navbar-style-dark" type="radio" name="config.name"
                            ...
                            <img class="img-fluid img-prototype d-dark-none"
                                src="{{ asset('backend/themes') }}/assets/img/generic/vertical-darker.png"
                                alt="" /><img class="img-fluid img-prototype d-light-none"
                                src="{{ asset('backend/themes') }}/assets/img/generic/vertical-lighter.png"
                                alt="" /><span class="label-text d-dark-none">
                ...
                <div class="row gx-2">
                    ...
                    <div class="col-6">
                        <input class="btn-check" id="navbarShapeSlim" name="navbar-shape" type="radio"
                            ...
                            <span class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none mb-0"
                                    src="{{ asset('backend/themes') }}/assets/img/generic/top-slim.png"
                                    alt="" /><img class="img-fluid img-prototype d-light-none mb-0"
                                    src="{{ asset('backend/themes') }}/assets/img/generic/top-slim-dark.png"
                                    alt="" /></span><span class="label-text">
                                Slim</span></label>
                    </div>
                </div>
                    ...
                    <div class="col-6">
                        <input class="btn-check" id="navbarTopDefault" name="navbar-top-style" type="radio"
                            ...
                            <span class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none mb-0"
                                    src="{{ asset('backend/themes') }}/assets/img/generic/top-default.png"
                                    alt="" /><img class="img-fluid img-prototype d-light-none mb-0"
                                    src="{{ asset('backend/themes') }}/assets/img/generic/top-style-darker.png"
                                    alt="" /></span><span class="label-text">Default</span></label>
                    </div>
                    <div class="col-6">
                        <input class="btn-check" id="navbarTopDarker" name="navbar-top-style" type="radio"
                            ...
                            <span class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none mb-0"
                                    src="{{ asset('backend/themes') }}/assets/img/generic/navbar-top-style-light.png"
                                    alt="" /><img class="img-fluid img-prototype d-light-none mb-0"
                                    src="{{ asset('backend/themes') }}/assets/img/generic/top-style-lighter.png"
    ...
    <script src="{{ asset('backend/themes') }}/vendors/popper/popper.min.js"></script>
    <script src="{{ asset('backend/themes') }}/vendors/bootstrap/bootstrap.min.js"></script>
    <script src="{{ asset('backend/themes') }}/vendors/anchorjs/anchor.min.js"></script>
    <script src="{{ asset('backend/themes') }}/vendors/is/is.min.js"></script>
    <script src="{{ asset('backend/themes') }}/vendors/fontawesome/all.min.js"></script>
    <script src="{{ asset('backend/themes') }}/vendors/lodash/lodash.min.js"></script>
    <script src="{{ asset('backend/themes') }}/../../../polyfill.io/v3/polyfill.min58be.js?features=window.scroll">
    </script>
    <script src="{{ asset('backend/themes') }}/vendors/list.js/list.min.js"></script>
    <script src="{{ asset('backend/themes') }}/vendors/feather-icons/feather.min.js"></script>
    <script src="{{ asset('backend/themes') }}/vendors/dayjs/dayjs.min.js"></script>
    <script src="{{ asset('backend/themes') }}/assets/js/phoenix.js"></script>
    <script src="{{ asset('backend/themes') }}/vendors/echarts/echarts.min.js"></script>
    <script src="{{ asset('backend/themes') }}/vendors/leaflet/leaflet.js"></script>
    <script src="{{ asset('backend/themes') }}/vendors/leaflet.markercluster/leaflet.markercluster.js"></script>
    <script src="{{ asset('backend/themes') }}/vendors/leaflet.tilelayer.colorfilter/leaflet-tilelayer-colorfilter.min.js">
    </script>
    <script src="{{ asset('backend/themes') }}/assets/js/ecommerce-dashboard.js"></script>
</body>
