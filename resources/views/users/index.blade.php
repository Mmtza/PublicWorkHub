            ...
            <div class="row align-items-stretch retro-layout">
                <div class="col-md-4">
                    <a href="single.html" class="h-entry mb-30 v-height gradient">
                        ...
                        <div class="featured-img"
                            style="background-image: url('{{ asset('users/themes') }}/images/img_2_horizontal.jpg')";>
                        </div>
                    ...
                    <a href="single.html" class="h-entry v-height gradient">
                        ...
                        <div class="featured-img"
                            style="background-image: url('{{ asset('users/themes') }}/images/img_5_horizontal.jpg');">
                        </div>
                ...
                <div class="col-md-4">
                    <a href="single.html" class="h-entry img-5 h-100 gradient">
                        ...
                        <div class="featured-img"
                            style="background-image: url('{{ asset('users/themes') }}/images/img_1_vertical.jpg');">
                        </div>
                ...
                <div class="col-md-4">
                    <a href="single.html" class="h-entry mb-30 v-height gradient">
                        ...
                        <div class="featured-img"
                            style="background-image: url('{{ asset('users/themes') }}/images/img_3_horizontal.jpg');">
                        </div>
                    ...
                    <a href="single.html" class="h-entry v-height gradient">
                        ...
                        <div class="featured-img"
                            style="background-image: url('{{ asset('users/themes') }}/images/img_4_horizontal.jpg');">
                        </div>
