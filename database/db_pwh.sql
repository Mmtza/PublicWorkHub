...
(5, 6, 'Mekanik Kendaraan', 'Mekanik Kendaraan-52023-12-12 23:27:06', '<p><span style=\"color: rgb(32, 33, 36);\">Melakukan pengecekan berkala kondisi semua kendaraan operasional sebelum beroperasi atau setelah beroperasi</span></p><p><span style=\"color: rgb(32, 33, 36);\">- Melakukan perawatan dan perbaikan seluruh unit kendaraan operasional</span></p><p><span style=\"color: rgb(32, 33, 36);\">- Memastikan seluruh kendaraan operasional berfungsi dengan baik</span></p><p><span style=\"color: rgb(32, 33, 36);\">- Melakukan storing jika dibutuhkan</span></p><p><span style=\"color: rgb(32, 33, 36);\">- Jenis Kendaraan yang akan ditangani Granmax, CDE, CDD, dan Fuso</span></p><p><span style=\"color: rgb(32, 33, 36);\">- Laki - laki</span></p><p><span style=\"color: rgb(32, 33, 36);\">- Pendidikan mínimal SMK Otomotif / Diploma</span></p><p><span style=\"color: rgb(32, 33, 36);\">- Usia masksimal 35 tahun</span></p><p><span style=\"color: rgb(32, 33, 36);\">- Memiliki SIM A dan SIM C</span></p><p><span style=\"color: rgb(32, 33, 36);\">- Memiliki pengalaman mínimal 1 tahun sebagai mekanik</span></p><p><span style=\"color: rgb(32, 33, 36);\">- Berpengalaman sebagai Mekanik Mobil &amp; Truck</span></p><p><span style=\"color: rgb(32, 33, 36);\">- Menguasai semua perbaikan dan perawatan mobil &amp; truck baik ringan maupun berat</span></p><p><span style=\"color: rgb(32, 33, 36);\">- Dapat bergabung segera</span></p>', 'Jakarta, Daerah Khusus Ibukota Jakarta', '2023-12-14 19:28:20'),
...
(22, '2023_12_16_025502_notification_table', 2);
...
CREATE TABLE `notifications` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `isi` text NOT NULL,
  `waktu_notifikasi` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `status` enum('unread','read') NOT NULL DEFAULT 'unread',
  `id_user` bigint(20) UNSIGNED NOT NULL,
  `id_has_user` bigint(20) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `notifications` (`id`, `isi`, `waktu_notifikasi`, `status`, `id_user`, `id_has_user`) VALUES
(2, '📰 membuat berita baru, menunggu diaktifkan', '2023-12-17 10:39:21', 'read', 7, 12),
(3, '📰 berita kamu telah diaktifkan oleh admin', '2023-12-17 11:05:50', 'read', 12, 7),
(4, '🏢 membuat loker baru', '2023-12-17 11:53:31', 'read', 6, 12),
(5, '📰 berita kamu telah dihapus oleh admin', '2023-12-17 12:02:32', 'unread', 12, 7),
(6, '🏢 membuat loker baru', '2023-12-17 12:04:08', 'read', 6, 12),
(7, '🏢 loker kamu telah dihapus oleh admin', '2023-12-17 12:03:22', 'read', 12, 6);
...
(4, 'user', 'user@gmail.com', '2023-12-12 15:33:58', '$2y$12$QK5zSPd1mrmD5ANteZhsXe8JV4O7t6QUWTjnVh1Jv59vc0.WaXdZi', 'hl6ZsTGdkM6x6XrphNzf0HYnjV6yhZWa2O1Jv5otyGMIhbjaVFv8yofASZB0', 'user', NULL, NULL, NULL, NULL, '2023-12-12 15:33:58', '2023-12-12 15:33:58', 0, 'avatar.png', 0, NULL),
...
ALTER TABLE `notifications`
  ...
  ADD KEY `notifications_id_has_user_foreign` (`id_has_user`);
...
--
ALTER TABLE `notifications`
  ADD CONSTRAINT `notifications_id_has_user_foreign` FOREIGN KEY (`id_has_user`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
